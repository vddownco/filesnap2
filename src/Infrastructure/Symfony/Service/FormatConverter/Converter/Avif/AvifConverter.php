...
namespace App\Infrastructure\Symfony\Service\FormatConverter\Converter\Avif;
...
final readonly class AvifConverter extends AbstractConverter
{
    ...
    protected function createConvertedFile(Snap $snap): File
    {
        ...
        if (imageavif($gdImage, $tempPath, self::QUALITY) === false) {
    ...
    {
        return sprintf('%s/%s.avif', sys_get_temp_dir(), $snap->getId()->toBase58());
    }
}
